...
set "SOURCE_PATH=%USERPROFILE%\AppData\LocalLow\InsightStudio\GodForsakenRelease\game_save_my_bak"
set "DEST_PATH=%USERPROFILE%\AppData\LocalLow\InsightStudio\GodForsakenRelease\game_save"
